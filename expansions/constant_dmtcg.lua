...
DM_EFFECT_DISCARD_REPLACE			=718	--If a card would be discarded, do something else to it instead ("Dava Torey, Seeker of Clouds" DM-06 18/110)
DM_EFFECT_CANNOT_SUMMON				=719	--Cannot summon a creature ("Gariel, Elemental of Sunbeams" DM-06 20/110)
...
DM_EFFECT_SILENT_SKILL				=729	--Keep creature tapped during untap step to use its "Silent Skill" ability ("Kejila, the Hidden Horror" DM-10 5/110)
