...
function scard.initial_effect(c)
	...
	--return
	dm.AddSingleDestroyedEffect(c,0,true,scard.rettg,scard.retop,DM_EFFECT_FLAG_CARD_CHOOSE)
end
scard.duel_masters_card=true
--scard.rettg=dm.ChooseCardFunction(PLAYER_PLAYER,dm.ShieldZoneFilter(Card.IsAbleToHand),DM_LOCATION_SHIELD,0,1,1,DM_HINTMSG_RTOHAND)
function scard.rettg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then return Duel.IsExistingTarget(dm.ShieldZoneFilter(Card.IsAbleToHand),tp,DM_LOCATION_SHIELD,0,1,nil) end
