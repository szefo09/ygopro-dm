...
function scard.initial_effect(c)
	...
	--to grave
	dm.AddUnblockedAttackTriggerEffect(c,0,nil,scard.tgtg,scard.tgop,EFFECT_FLAG_CARD_TARGET,scard.tgcon)
end
scard.duel_masters_card=true
scard.evolution_race_list={DM_RACE_XENOPARTS,DM_RACE_GIANT_INSECT,DM_RACE_GIANT}
--power up
function scard.powtg(e,c)
	return c~=e:GetHandler() and c:DMIsRace(DM_RACE_XENOPARTS,DM_RACE_GIANT_INSECT)
end
--to grave
