...
function scard.powval(e,c)
	local g=Duel.GetMatchingGroup(Card.IsCivilization,c:GetControler(),DM_LOCATION_BATTLE,DM_LOCATION_BATTLE,nil)
	return g:GetClassCount(Card.GetCivilization)>=DM_CIVILIZATION_COUNT
end
--double breaker
