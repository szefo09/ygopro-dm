...
function scard.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	ye4:SetTargetRange(DM_LOCATION_BZONE,DM_LOCATION_BZONE)
	...
	ye5:SetTargetRange(DM_LOCATION_BZONE,DM_LOCATION_BZONE)
	...
	ye6:SetTargetRange(DM_LOCATION_BZONE,DM_LOCATION_BZONE)
	ye6:SetValue(1)
	...
	ye9:SetTargetRange(DM_LOCATION_BZONE,DM_LOCATION_BZONE)
	...
	ye15:SetTargetRange(DM_LOCATION_SZONE,DM_LOCATION_SZONE)
	...
	ye20:SetOperation(function(e,tp,eg,ep,ev,re,r,rp)
		...
		--[[if not d or not d:IsLocation(DM_LOCATION_BZONE) then
...
function scard.poscon1(e)
	...
	return Duel.IsExistingMatchingCard(scard.posfilter1,turnp,DM_LOCATION_BZONE,0,1,nil)
		or Duel.IsExistingMatchingCard(dm.ManaZoneFilter(scard.posfilter2),turnp,DM_LOCATION_MZONE,0,1,nil)
end
function scard.posop1(e,tp,eg,ep,ev,re,r,rp)
	local turnp=Duel.GetTurnPlayer()
	local g1=Duel.GetMatchingGroup(scard.posfilter1,turnp,DM_LOCATION_BZONE,0,nil)
...
function scard.poscon2(e)
	return Duel.IsExistingMatchingCard(scard.posfilter3,Duel.GetTurnPlayer(),DM_LOCATION_BZONE,0,1,nil)
end
...
function scard.desop2(e,tp,eg,ep,ev,re,r,rp)
	local a=Duel.GetAttacker()
	local d=Duel.GetAttackTarget()
	if not a or not a:IsLocation(DM_LOCATION_BZONE) or not d or not d:IsLocation(DM_LOCATION_BZONE) or not d:IsDefensePos() then return end
