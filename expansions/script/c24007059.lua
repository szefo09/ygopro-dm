...
function scard.tgop(e,tp,eg,ep,ev,re,r,rp)
	dm.SendtoGraveOperation(tp,dm.ManaZoneFilter(),DM_LOCATION_MANA,0,1)(e,tp,eg,ep,ev,re,r,rp)
	dm.SendtoGraveOperation(1-tp,dm.ManaZoneFilter(),0,DM_LOCATION_MANA,1)(e,tp,eg,ep,ev,re,r,rp)
end
