...
function scard.tgop(e,tp,eg,ep,ev,re,r,rp)
	dm.SendtoGraveOperation(PLAYER_SELF,dm.ManaZoneFilter(Card.DMIsAbleToGrave),DM_LOCATION_MANA,0,1)(e,tp,eg,ep,ev,re,r,rp)
	dm.SendtoGraveOperation(PLAYER_OPPO,dm.ManaZoneFilter(Card.DMIsAbleToGrave),0,DM_LOCATION_MANA,1)(e,tp,eg,ep,ev,re,r,rp)
end
