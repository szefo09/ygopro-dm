...
function scard.initial_effect(c)
	...
	--mana cost up
	dm.EnableUpdateManaCost(c,LOCATION_HAND,LOCATION_HAND,scard.mccon1,scard.mctg1,1,scard.mccon2,scard.mctg2)
end
...
function scard.mctg1(e,c)
	return c:IsType(DM_TYPE_CREATURE) and c:IsCivilization(DM_CIVILIZATION_NATURE)
end
function scard.mcfilter1(c)
	return c:IsSpell() and c:IsCivilization(DM_CIVILIZATION_NATURE)
end
...
function scard.mctg2(e,c)
	return c:IsType(TYPE_SPELL) and c:IsCivilization(DM_CIVILIZATION_NATURE)
end
