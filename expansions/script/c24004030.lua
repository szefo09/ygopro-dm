...
function scard.initial_effect(c)
	...
	--power up
	dm.EnableUpdatePower(c,2000,nil,DM_LOCATION_BATTLE,DM_LOCATION_BATTLE,aux.TargetBoolFunction(Card.IsDMRace,DM_RACE_DEMON_COMMAND))
	--get ability (blocker)
	...
	e2:SetTarget(aux.TargetBoolFunction(Card.IsDMRace,DM_RACE_DEMON_COMMAND))
	...
	e3:SetTarget(aux.TargetBoolFunction(Card.IsDMRace,DM_RACE_DEMON_COMMAND))
	c:RegisterEffect(e3)
end
