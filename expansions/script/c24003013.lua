...
function scard.retop(e,tp,eg,ep,ev,re,r,rp)
	...
	local g1=Duel.SelectMatchingCard(tp,dm.ManaZoneFilter(),tp,DM_LOCATION_MANA,0,2,2,nil)
	...
	local g2=Duel.SelectMatchingCard(1-tp,dm.ManaZoneFilter(Card.IsCanBeEffectTarget),1-tp,DM_LOCATION_MANA,0,2,2,nil,e)
