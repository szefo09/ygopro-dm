...
function scard.rettg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	local g=Duel.SelectTarget(tp,scard.retfilter,tp,DM_LOCATION_BATTLE,DM_LOCATION_BATTLE,1,1,nil)
	...
	Duel.Hint(HINT_SELECTMSG,tp,DM_HINTMSG_RTOHAND)
	Duel.SelectTarget(tp,scard.retfilter,tp,DM_LOCATION_BATTLE,DM_LOCATION_BATTLE,0,ct,g)
end
