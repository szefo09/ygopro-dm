...
function scard.initial_effect(c)
	...
	e2:SetTarget(aux.TargetBoolFunction(Card.IsCivilization,DM_CIVILIZATIONS_LF))
	...
	e3:SetTarget(aux.TargetBoolFunction(Card.IsCivilization,DM_CIVILIZATIONS_LF))
	c:RegisterEffect(e3)
end
