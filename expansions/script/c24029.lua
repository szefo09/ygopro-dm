...
scard.tgop1=dm.SendtoGraveOperation(PLAYER_SELF,dm.ManaZoneFilter(Card.DMIsAbleToGrave),0,DM_LOCATION_MANA,1)
...
function scard.tgtg2(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	for tc in aux.Next(eg) do
		...
		e1:SetReset(RESET_EVENT+RESETS_STANDARD-RESET_LEAVE-RESET_TOHAND)
